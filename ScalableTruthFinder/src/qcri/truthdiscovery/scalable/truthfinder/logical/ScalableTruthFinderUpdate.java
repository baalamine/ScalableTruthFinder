 ...
 */
public class ScalableTruthFinderUpdate extends Update<Double, KeyValuePair<Integer, KeyValuePair<Integer, List<ValueBucket>>>> {
	...
	public Double update(KeyValuePair<Integer, KeyValuePair<Integer, List<ValueBucket>>> input, RheemContext context) 
	{
		...
		{
			for (String s : newscores.keySet()) previous_scores.put(s, 0.8) ;			
		}
		else
		{
