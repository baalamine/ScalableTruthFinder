 ...
 */
public class TruthFinderCompute extends Compute<KeyValuePair<Integer, qcri.dafna.dataModel.data.DataSet>, KeyValuePair<Integer, KeyValuePair<Integer, List<SourceClaim>>>> {
	...
	@Override
	public KeyValuePair<Integer, qcri.dafna.dataModel.data.DataSet> compute(KeyValuePair<Integer, KeyValuePair<Integer, List<SourceClaim>>>  input, RheemContext context) {
		...
		return new KeyValuePair<Integer, qcri.dafna.dataModel.data.DataSet>(1, kv) ;
	}
